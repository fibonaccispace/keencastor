...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/neural-network', component: () => import('/pages/NeuralNetwork.vue') },
    { path: '/notes', component: () => import('/pages/Notes.vue') },
    { path: '/board', component: () => import('/pages/Board.vue') },
    { path: '/flappy-bird-ai', component: () => import('/pages/FlappyAI.vue') },
    { path: '/maxwell-boltzmann-distribution', component: () => import('/pages/MaxwellBoltzmann.vue') },
    ...
    { path: '/procedural-generation', component: () => import('/pages/Proceed2D.vue') },
    ...
    { path: '/procedural-generation-3d', component: () => import('/pages/Proceed3D.vue') },
    { path: '/nuclear-reaction', component: () => import('/pages/NuclearReaction.vue') },
    { path: '/3d-visualization', component: () => import('/pages/Vision3D.vue') },
    {
      path: '/:pathMatch(.*)*',
      name: 'error',
